// Chip1Dlg.cpp : implementation file
//
...
CChip1Dlg::CChip1Dlg(CWnd* pParent /*=NULL*/)
	: CResizingDialog(CChip1Dlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CChip1Dlg)
	//}}AFX_DATA_INIT
}

void CChip1Dlg::DoDataExchange(CDataExchange* pDX)
{
	CResizingDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CChip1Dlg)
	...
	DDX_Control(pDX, IDC_ClearDark1, m_clearDark);
	DDX_Control(pDX, IDC_AutoGetOpticGain1, m_getGain);
	DDX_Control(pDX, IDC_AddDark1, m_addDark);
	DDX_Control(pDX, IDC_ClearCalibration, m_clearCal);
	DDX_Control(pDX, IDC_GetCalibration, m_getCal);
	DDX_Control(pDX, IDC_CalibrationTest1, m_caltest);
	DDX_Control(pDX, IDC_AutoSetInteTime1, m_autosetTime);
	DDX_Control(pDX, IDC_XYList, m_xylist);
	DDX_Control(pDX, IDC_shootset, m_shootset);
	DDX_Control(pDX, IDC_cbOpticGain1, m_cbOpticGain1);
	DDX_Control(pDX, IDC_cbWLSteptype1, m_cbWLSteptype1);
	DDX_Control(pDX, IDC_SetChipList1, m_chipList);
...
BEGIN_MESSAGE_MAP(CChip1Dlg, CResizingDialog)
	//{{AFX_MSG_MAP(CChip1Dlg)
/*	ON_BN_CLICKED(IDC_Test_IF, OnTestIF)
	...
	ON_BN_CLICKED(IDC_shootset, Onshootset)
	ON_BN_CLICKED(IDC_CalibrationTest1, OnCalibrationTest1)
	ON_BN_CLICKED(IDC_ClearDark1, OnClearDark1)
	ON_BN_CLICKED(IDC_AddDark1, OnAddDark1)
	ON_BN_CLICKED(IDC_AutoSetInteTime1, OnAutoSetInteTime1)
	ON_WM_ERASEBKGND()
	ON_WM_CTLCOLOR()
	ON_BN_CLICKED(IDC_ClearCalibration, OnClearCalibration)
	ON_BN_CLICKED(IDC_GetCalibration, OnGetCalibration)
	ON_BN_CLICKED(IDC_AutoGetOpticGain1, OnAutoGetOpticGain1)
...
extern bool tempVFaverage;
extern bool updateRect;
double tempV1 = 0, tempI1 = 0;
long tempDelay = 0;
double tempV2 = 0, tempI2 = 0;
double tempV3 = 0, tempI3 = 0;
...
int calsta_average = 5;
int calsta_boxcar = 3;

BOOL CChip1Dlg::OnInitDialog() 
{
	CResizingDialog::OnInitDialog();

	// TODO: Add extra initialization here
	chip = 0;
	m_cbWLSteptype1.InsertString(0, "1nm");
	m_cbWLSteptype1.InsertString(1, "5nm");

	m_cbOpticGain1.InsertString(0, "低亮LED");
	m_cbOpticGain1.InsertString(1, "普亮LED");
	m_cbOpticGain1.InsertString(2, "高亮LED");
	m_cbOpticGain1.InsertString(3, "超高亮LED");
...
LRESULT CChip1Dlg::PopulateComboList(WPARAM wParam, LPARAM lParam)
{
...
bool CChip1Dlg::setParameter(int i)
{
	CString s, str;
...
bool CChip1Dlg::initdlg()
{
	...
	m_cbWLSteptype1.SetCurSel(intWLSteps[chip]);
	m_cbOpticGain1.SetCurSel(intOpticGain[chip]);

	str.Format("%0.1f", intIntegrationTime[chip]);
	SetDlgItemText(IDC_IntegrationTime1, str);
...
void CChip1Dlg::initAuthorityItem()
{
	CString strItem, str;
	m_caltest.EnableWindow(true);
	m_getCal.EnableWindow(true);
...
void CChip1Dlg::hideAuthorityItem()
{
...
int CChip1Dlg::searchItem(CString str)
{
...
void CChip1Dlg::HandleCheck(CString str, CButton *m_check)
{
...
bool CChip1Dlg::updateItemforlevel()
{
...
/*
void CChip1Dlg::OnTestIF() 
{
	// TODO: Add your control notification handler code here
	HandleCheck("IF", &m_tIF);
}

void CChip1Dlg::OnTestIR() 
{
	// TODO: Add your control notification handler code here
	HandleCheck("IR", &m_tIR);
}

void CChip1Dlg::OnTestVF() 
{
	// TODO: Add your control notification handler code here
	HandleCheck("VF", &m_tVF);
}

void CChip1Dlg::OnTestVR() 
{
	// TODO: Add your control notification handler code here
	HandleCheck("VR", &m_tVR);
}

void CChip1Dlg::OnTestDVF() 
{
	// TODO: Add your control notification handler code here
	HandleCheck("DVF", &m_tDVF);
}

void CChip1Dlg::OnTestTHY() 
{
	// TODO: Add your control notification handler code here
	HandleCheck("THY", &m_tTHY);
}

void CChip1Dlg::OnTestIV() 
{
	// TODO: Add your control notification handler code here
	HandleCheck("IV", &m_tIV);
}

void CChip1Dlg::OnTestXYZ() 
{
	// TODO: Add your control notification handler code here
	HandleCheck("XYZ", &m_tXYZ);
	if(1 == m_tXYZ.GetCheck())
	{
		m_shootset.EnableWindow(true);
	}
	else
	{
		m_shootset.EnableWindow(false);
	}
}

void CChip1Dlg::OnTestWL() 
{
	// TODO: Add your control notification handler code here
	HandleCheck("WL", &m_tWL);
}

void CChip1Dlg::OnTestPWL() 
{
	// TODO: Add your control notification handler code here
	HandleCheck("PWL", &m_tPWL);
}

void CChip1Dlg::OnTestDeltaWL() 
{
	// TODO: Add your control notification handler code here
	HandleCheck("DeltaWL", &m_tDeltaWL);
}

void CChip1Dlg::OnTestPUR() 
{
	// TODO: Add your control notification handler code here
	HandleCheck("PUR", &m_tPUR);
}

void CChip1Dlg::OnTestCCT() 
{
	// TODO: Add your control notification handler code here
	HandleCheck("CCT", &m_tCCT);
}

void CChip1Dlg::OnTestCRI() 
{
	// TODO: Add your control notification handler code here
...
bool CChip1Dlg::getParameter()
{
	...
	intWLSteps[chip] = m_cbWLSteptype1.GetCurSel();
    intOpticGain[chip] = m_cbOpticGain1.GetCurSel(); 

	GetDlgItemText(IDC_IntegrationTime1, str);
...
bool CChip1Dlg::getParameterbyhand()
{
	c[chip] = testItemChip[chip];
	CString str, testItem, testItem2;
	CString Items[18] = {"IR", "VR", "VZ", "VF", "IF", "IV", "IE", "LE", "LV",
...
void CChip1Dlg::OnAutoSetInteTime1() 
{
	// TODO: Add your control notification handler code here
	CString str;
	double maxpower = 0;
...
/*	setparam->GetDlgItemText(IDC_ScanTimes, str);
	...
	{
		OpenSupply(3);
		Supply(tempV2, tempI2, 2);
		Supply(tempV3, tempI3, 3);
	}
	Delay(delay * 1000);

	SetDlgItemText(IDC_AutoSetInteTime1, "正在获取");
	...
	if(maxpower > (recommended * 1.1))
	{
		...
		SetDlgItemText(IDC_AutoSetInteTime1, "自动调整积分时间");
	...
	SetDlgItemText(IDC_IntegrationTime1, str);
	SetDlgItemText(IDC_AutoSetInteTime1, "自动获取积分时间");
...
void CChip1Dlg::OnClearDark1() 
{
	// TODO: Add your control notification handler code here
	InitCalDarkParam(chip);
}

void CChip1Dlg::OnAddDark1() 
{
	// TODO: Add your control notification handler code here
	int time = 0; 
	CString str;
...
void CChip1Dlg::OnCalibrationTest1() 
{
	// TODO: Add your control notification handler code here
//	DoubleArray sa;
//	OOI_PARAM ooip;
...
// 	boxcar = atoi(str);
	...
	for(int i=0; i<testItemChip[chip]; i++)
	{
		...
		else if(0 == strcmp(testItem, "VF"))
		{
			...
			if(!getBering())
			{
				TestValue += systemset.VRoffset[0];
			}

			if(tempmixopen && tempVFaverage)
			{
				OpenLightSet(tempchiptype, 1);
				TestValue += getVF(VCom, ICom, delay);
				if(!getBering())
				{
					TestValue += systemset.VRoffset[1];
				}
				
				OpenLightSet(tempchiptype, 2);
				TestValue += getVF(VCom, ICom, delay);
				if(!getBering())
				{
		...
		{
			opticgain = m_cbOpticGain1.GetCurSel();
			if(tempmixopen)
			{
				GetDlgItemText(IDC_KLV, str);
				tempV1 = atof(str);
				...
				SetSupplyParam(tempV2, tempV3, tempI2, tempI3);
				TestValue = getYbit(true, opticgain, tempV1, tempI1, tempDelay, true);
			}
			else
			{
		...
		else
		{
			...
			{
				wlSteps = m_cbWLSteptype1.GetCurSel();
...
// 		//文件保存看看
// 		FILE *fp;
// 		if((fp=fopen("c:\\TestAD1.dat","wt"))==0)
// 		{
// 		}
// 		else
// 		{
...
void CChip1Dlg::OnClearCalibration() 
{
	// TODO: Add your control notification handler code here
...
void CChip1Dlg::OnGetCalibration() 
{
	// TODO: Add your control notification handler code here
//	DoubleArray sa;
//	OOI_PARAM ooip;
...
void CChip1Dlg::OnAutoGetOpticGain1() 
{
	// TODO: Add your control notification handler code here
	...
	{		
		...
		for(i=0; i<4; i++)
		{
			tempvalue = getYbit(true, i, voltage, current, delay, false);
	...
	m_cbOpticGain1.SetCurSel(gain);
}


void CChip1Dlg::SetDialogFace()
{
...
BOOL CChip1Dlg::OnEraseBkgnd(CDC* pDC) 
{
...
HBRUSH CChip1Dlg::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor) 
{
...
BOOL CChip1Dlg::OnNotify(WPARAM wParam, LPARAM lParam, LRESULT* pResult) 
{
...
//		AfxMessageBox(str);
	...
	return CResizingDialog::OnNotify(wParam, lParam, pResult);
}

BOOL CChip1Dlg::OnChildNotify(UINT message, WPARAM wParam, LPARAM lParam, LRESULT* pLResult) 
{
	// TODO: Add your specialized code here and/or call the base class
	return CResizingDialog::OnChildNotify(message, wParam, lParam, pLResult);
}
