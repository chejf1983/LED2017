// Chip2Dlg.cpp : implementation file
//
...
CChip2Dlg::CChip2Dlg(CWnd* pParent /*=NULL*/)
	: CResizingDialog(CChip2Dlg::IDD, pParent)
{
	//{{AFX_DATA_INIT(CChip2Dlg)
	//}}AFX_DATA_INIT
}


void CChip2Dlg::DoDataExchange(CDataExchange* pDX)
{
	CResizingDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CChip2Dlg)
	...
	DDX_Control(pDX, IDC_ClearDark2, m_clearDark);
	DDX_Control(pDX, IDC_AutoGetOpticGain2, m_getGain);
	DDX_Control(pDX, IDC_AddDark2, m_addDark);
	DDX_Control(pDX, IDC_ClearCalibration, m_clearCal);
	DDX_Control(pDX, IDC_GetCalibration, m_getCal);
	DDX_Control(pDX, IDC_CalibrationTest2, m_caltest);
	DDX_Control(pDX, IDC_AutoSetInteTime2, m_autosetTime);
	DDX_Control(pDX, IDC_shootset2, m_shootset2);
	DDX_Control(pDX, IDC_XYList, m_xylist);
	DDX_Control(pDX, IDC_cbOpticGain2, m_cbOpticGain2);
	DDX_Control(pDX, IDC_cbWLSteptype2, m_cbWLSteptype2);
	...
	DDX_Control(pDX, IDC_SetChipList2, m_chipList);
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(CChip2Dlg, CResizingDialog)
	//{{AFX_MSG_MAP(CChip2Dlg)
/*	ON_BN_CLICKED(IDC_Test_IF, OnTestIF)
	...
	ON_BN_CLICKED(IDC_shootset2, Onshootset2)
	ON_BN_CLICKED(IDC_ClearDark2, OnClearDark2)
	ON_BN_CLICKED(IDC_AddDark2, OnAddDark2)
	ON_BN_CLICKED(IDC_CalibrationTest2, OnCalibrationTest2)
	ON_BN_CLICKED(IDC_AutoSetInteTime2, OnAutoSetInteTime2)
	ON_WM_ERASEBKGND()
	ON_WM_CTLCOLOR()
	ON_BN_CLICKED(IDC_ClearCalibration, OnClearCalibration)
	ON_BN_CLICKED(IDC_GetCalibration, OnGetCalibration)
	ON_BN_CLICKED(IDC_AutoGetOpticGain2, OnAutoGetOpticGain2)
...
BOOL CChip2Dlg::OnInitDialog() 
{
	CResizingDialog::OnInitDialog();
	
	// TODO: Add extra initialization here
	chip = 1;
	m_cbWLSteptype2.InsertString(0, "1nm");
	m_cbWLSteptype2.InsertString(1, "5nm");
	
	m_cbOpticGain2.InsertString(0, "低亮LED");
	m_cbOpticGain2.InsertString(1, "普亮LED");
	m_cbOpticGain2.InsertString(2, "高亮LED");
	m_cbOpticGain2.InsertString(3, "超高亮LED");
...
LRESULT CChip2Dlg::PopulateComboList(WPARAM wParam, LPARAM lParam)
{
...
bool CChip2Dlg::setParameter(int i)
{
	CString s, str;
...
bool CChip2Dlg::initdlg()
{
	...
	m_cbWLSteptype2.SetCurSel(intWLSteps[chip]);
	m_cbOpticGain2.SetCurSel(intOpticGain[chip]);

	str.Format("%0.1f", intIntegrationTime[chip]);
	SetDlgItemText(IDC_IntegrationTime2, str);
...
void CChip2Dlg::initAuthorityItem()
{
	CString strItem, str;
	m_caltest.EnableWindow(true);
	m_getCal.EnableWindow(true);
...
void CChip2Dlg::hideAuthorityItem()
{
...
int CChip2Dlg::searchItem(CString str)
{
...
void CChip2Dlg::HandleCheck(CString str, CButton *m_check)
{
...
bool CChip2Dlg::updateItemforlevel()
{
...
/*
void CChip2Dlg::OnTestIF() 
{
	// TODO: Add your control notification handler code here
	HandleCheck("IF", &m_tIF);
}

void CChip2Dlg::OnTestIR() 
{
	// TODO: Add your control notification handler code here
	HandleCheck("IR", &m_tIR);
}

void CChip2Dlg::OnTestVF() 
{
	// TODO: Add your control notification handler code here
	HandleCheck("VF", &m_tVF);
}

void CChip2Dlg::OnTestVR() 
{
	// TODO: Add your control notification handler code here
	HandleCheck("VR", &m_tVR);
}

void CChip2Dlg::OnTestDVF() 
{
	// TODO: Add your control notification handler code here
	HandleCheck("DVF", &m_tDVF);
}

void CChip2Dlg::OnTestTHY() 
{
	// TODO: Add your control notification handler code here
	HandleCheck("THY", &m_tTHY);
}

void CChip2Dlg::OnTestIV() 
{
	// TODO: Add your control notification handler code here
	HandleCheck("IV", &m_tIV);
}

void CChip2Dlg::OnTestXYZ() 
{
	// TODO: Add your control notification handler code here
	HandleCheck("XYZ", &m_tXYZ);
	if(1 == m_tXYZ.GetCheck())
	{
		m_shootset2.EnableWindow(true);
	}
	else
	{
		m_shootset2.EnableWindow(false);
	}
}

void CChip2Dlg::OnTestWL() 
{
	// TODO: Add your control notification handler code here
	HandleCheck("WL", &m_tWL);
}

void CChip2Dlg::OnTestPWL() 
{
	// TODO: Add your control notification handler code here
	HandleCheck("PWL", &m_tPWL);
}

void CChip2Dlg::OnTestDeltaWL() 
{
	// TODO: Add your control notification handler code here
	HandleCheck("DeltaWL", &m_tDeltaWL);
}

void CChip2Dlg::OnTestPUR() 
{
	// TODO: Add your control notification handler code here
	HandleCheck("PUR", &m_tPUR);
}

void CChip2Dlg::OnTestCCT() 
{
	// TODO: Add your control notification handler code here
	HandleCheck("CCT", &m_tCCT);
}

void CChip2Dlg::OnTestCRI() 
{
	// TODO: Add your control notification handler code here
	HandleCheck("CRI", &m_tCRI);
}*/

void CChip2Dlg::SetMixLightParam(bool enable)
{
	int i = 0;
...
void CChip2Dlg::SetVFaverage(bool enable)
{
	int i = 0;
...
bool CChip2Dlg::getParameter()
{
	...
	intWLSteps[chip] = m_cbWLSteptype2.GetCurSel();
    intOpticGain[chip] = m_cbOpticGain2.GetCurSel(); 

	GetDlgItemText(IDC_IntegrationTime2, str);
...
bool CChip2Dlg::getParameterbyhand()
{
	c[chip] = testItemChip[chip];
	CString str, testItem, testItem2;
	CString Items[18] = {"IR", "VR", "VZ", "VF", "IF", "IV", "IE", "LE", "LV",
			...
			if(0 == strcmp(testItem2, Items[itemsnum]))
			{
				...
				else
				{
					...
					if(engineer || Operator)
					{
						...
						if(m_chipList.GetItemText(j, 5) == "+")						
						{
							CHIP[chip][i].Calway = 0;
							CHIP[chip][i].CalParam2 = atof(m_calItemList.GetItemText(j, 7));
						}
						else if(m_chipList.GetItemText(j, 5) == "*")
						{
							CHIP[chip][i].Calway = 1;
							CHIP[chip][i].CalParam1 = atof(m_calItemList.GetItemText(j, 6));
						}
...
void CChip2Dlg::Onshootset2() 
{
	...
	m_shootdiagram.m_shootchip = 1;
}

void CChip2Dlg::OnAutoSetInteTime2() 
{
	// TODO: Add your control notification handler code here
	CString str;
	double maxpower = 0;
...
/*	setparam->GetDlgItemText(IDC_ScanTimes, str);
	...
	SetDlgItemText(IDC_AutoSetInteTime2, "正在获取");
	...
	if(maxpower > (recommended * 1.1))
	{
		...
		SetDlgItemText(IDC_AutoSetInteTime2, "自动调整积分时间");
...
void CChip2Dlg::OnClearDark2() 
{
	// TODO: Add your control notification handler code here
	InitCalDarkParam(chip);
}

void CChip2Dlg::OnAddDark2() 
{
	// TODO: Add your control notification handler code here
	int time = 0; 
	CString str;
...
void CChip2Dlg::OnCalibrationTest2() 
{
	// TODO: Add your control notification handler code here
	double *spectrum;
	...
	for(int i=0; i<testItemChip[chip]; i++)
	{
		...
		{
			opticgain = m_cbOpticGain2.GetCurSel();
		...
		else
		{
			...
			{
				wlSteps = m_cbWLSteptype2.GetCurSel();
...
// 		//文件保存看看
// 		FILE *fp;
// 		if((fp=fopen("c:\\TestAD2.dat","wt"))==0)
// 		{
// 		}
// 		else
// 		{
...
void CChip2Dlg::OnClearCalibration() 
{
	// TODO: Add your control notification handler code here
...
void CChip2Dlg::OnGetCalibration() 
{
	// TODO: Add your control notification handler code here
//	DoubleArray sa;
//	OOI_PARAM ooip;
...
void CChip2Dlg::OnAutoGetOpticGain2() 
{
	// TODO: Add your control notification handler code here
	...
	m_cbOpticGain2.SetCurSel(gain);
}

void CChip2Dlg::OnChangeKlv() 
{
...
BOOL CChip2Dlg::OnEraseBkgnd(CDC* pDC) 
{
...
HBRUSH CChip2Dlg::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor) 
{
