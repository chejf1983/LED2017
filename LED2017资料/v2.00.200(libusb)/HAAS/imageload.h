...
// Success                           filename      hDib     save type
...
// Last Error                       filename      Memory     page _IMAGE_INFO structure pointer
int __declspec (dllexport) LoadImg( const char *, HGLOBAL *, int, _IMAGE_INFO * );

// Last Error                          filename      page _IMAGE_INFO structure pointer
...
//int __declspec (dllexport) ListSubfileValues( FILE *, DWORD * );
