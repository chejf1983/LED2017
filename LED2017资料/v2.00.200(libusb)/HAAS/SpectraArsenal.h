...
SPECTRAARSENAL_API int SA_GetIntegrationTime (int spectrometerIndex, int * usec);
SPECTRAARSENAL_API int SA_SetAverageTimes(int spectrometerIndex, int AverageTimes);
SPECTRAARSENAL_API int SA_GetAverageTimes(int spectrometerIndex, int * AverageTimes);
...
SPECTRAARSENAL_API int SA_AsynchronousScanStart(int spectrometerIndex);
SPECTRAARSENAL_API int SA_AsynchronousGetState(int spectrometerIndex, int *pState);
