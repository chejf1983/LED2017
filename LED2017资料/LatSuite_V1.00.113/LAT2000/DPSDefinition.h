...
struct LimitData
{
	LimitFloat LimitCurrentRange1;	// 0 - 150V
	LimitFloat LimitCurrentRange2;	// 0 - 300V
	LimitFloat LimitVoltageRange1;	// 0 - 150V
	LimitFloat LimitVoltageRange2;	// 0 - 300V
	LimitFloat LimitPower;
	LimitFloat LimitFrequency;
	LimitFloat LimitExternalCurrentFactor;
