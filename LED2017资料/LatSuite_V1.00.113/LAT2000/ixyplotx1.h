...
class CIxyplotx1 : public CWnd
{
protected:
	DECLARE_DYNCREATE(CIxyplotx1)
public:
...
enum
{
    ...
    ipriChannel = 1,
    ipriAuto = 2
}TxiPlotReferenceIndividual;
enum
{
    ipcdpmsXandY = 0,
    ipcdpmsXOnly = 1,
    ipcdpmsYOnly = 2
}TxiPlotChannelDataPointMoveStyle;
enum
{
    iptisMinimum = 0,
    iptisMajor = 1,
    iptisMinor = 2
}TxiPlotTrackingIncrementStyle;
enum
{
    ipifBitmap = 0,
    ipifEnhancedMetaFile = 1,
    ipifJPEG = 2,
    ipifPNG = 3
}TxiPlotImageFormatStyle;
...
//
	...
	{
		static BYTE parms[] = VTS_R8 ;
		InvokeHelper(0xc1, DISPATCH_METHOD, VT_EMPTY, NULL, parms, MinutesPerMillimeter);
	}
	CString get_DefaultSaveImageDirectory()
	{
		CString result;
		InvokeHelper(0xc2, DISPATCH_PROPERTYGET, VT_BSTR, (void*)&result, NULL);
		return result;
	}
	void put_DefaultSaveImageDirectory(LPCTSTR newValue)
	{
		static BYTE parms[] = VTS_BSTR ;
		InvokeHelper(0xc2, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, newValue);
	}
	long get_DefaultSaveImageFormat()
	{
		long result;
		InvokeHelper(0xc3, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, NULL);
		return result;
	}
	void put_DefaultSaveImageFormat(long newValue)
	{
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0xc3, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, newValue);
	}
	CString get_DefaultPropertyDirectory()
	{
		CString result;
		InvokeHelper(0xc4, DISPATCH_PROPERTYGET, VT_BSTR, (void*)&result, NULL);
		return result;
	}
	void put_DefaultPropertyDirectory(LPCTSTR newValue)
	{
		static BYTE parms[] = VTS_BSTR ;
		InvokeHelper(0xc4, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, newValue);
	}
	CString get_DefaultDataDirectory()
	{
		CString result;
		InvokeHelper(0xc5, DISPATCH_PROPERTYGET, VT_BSTR, (void*)&result, NULL);
		return result;
	}
	void put_DefaultDataDirectory(LPCTSTR newValue)
	{
		static BYTE parms[] = VTS_BSTR ;
		InvokeHelper(0xc5, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, newValue);
	}
	CString get_DefaultAnnotationDirectory()
	{
		CString result;
		InvokeHelper(0xc6, DISPATCH_PROPERTYGET, VT_BSTR, (void*)&result, NULL);
		return result;
	}
	void put_DefaultAnnotationDirectory(LPCTSTR newValue)
	{
		static BYTE parms[] = VTS_BSTR ;
		InvokeHelper(0xc6, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, parms, newValue);
	}
	void SetCustomizeLabelText(LPCTSTR Value)
	{
		static BYTE parms[] = VTS_BSTR ;
		InvokeHelper(0xc7, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Value);
	}
	BOOL get_DifferentialPropertySave()
	{
		BOOL result;
		InvokeHelper(0xc8, DISPATCH_PROPERTYGET, VT_BOOL, (void*)&result, NULL);
		return result;
	}
	void put_DifferentialPropertySave(BOOL newValue)
	{
		static BYTE parms[] = VTS_BOOL ;
