...
class CIpiechartx1 : public CWnd
{
protected:
	DECLARE_DYNCREATE(CIpiechartx1)
public:
...
//
	...
	long get_StartDegrees()
	{
		long result;
		InvokeHelper(0x7, DISPATCH_PROPERTYGET, VT_I4, (void*)&result, NULL);
		return result;
	}
	void put_StartDegrees(long newValue)
	{
		static BYTE parms[] = VTS_I4 ;
	...
	void AddItem(LPCTSTR Title, unsigned long Color, double Value)
	{
		...
		InvokeHelper(0x2d, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Title, Color, Value);
	}
	void RemoveItem(long Index)
	{
		static BYTE parms[] = VTS_I4 ;
		InvokeHelper(0x2e, DISPATCH_METHOD, VT_EMPTY, NULL, parms, Index);
	}
	void ClearList()
	{
