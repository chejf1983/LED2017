...
// 设置仪器类型
extern BOOL DllExport DPS_SetDeviceType(DeviceType deviceType);

// 初始化，指定通信串口
// This function should be called after the calling of SetDeviceType
// if iDeviceAddress is none-positive, the default device address will be used
extern BOOL DllExport DPS_InitializeComm(int iCOM, int iDeviceAddress = -1);
