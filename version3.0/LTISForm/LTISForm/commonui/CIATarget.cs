...
{
    public delegate void InputXY(double x, double y);

    public partial class CIATarget : UserControl
    {
        public CIATarget()
        {
            InitializeComponent();
        ...
        private double x, y;
        public event InputXY XYEvent;
        public bool MouseEnable
        {
            get { return this.mouseEnable; }
            set
            {
                this.mouseEnable = value;

                this.cie1931.ChartAreas[0].AxisX.ScaleView.Zoomable = !value;
                this.cie1931.ChartAreas[0].AxisY.ScaleView.Zoomable = !value;
            }
        }
        private bool mouseEnable = false;
        private void cie1931_MouseClick(object sender, MouseEventArgs e)
        {
            if (this.mouseEnable)
            {
        ...
        //设置区域框图
        public void SetDataSet(BindingList<CArea> datasource)
        {
        ...
        {
            if (this.cie1931.ChartAreas[0].AxisX.ScaleView.Zoomable)
            {
